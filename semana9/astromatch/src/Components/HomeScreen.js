...
import { HomeConteiner, ContentScreen,  Header, TitleLogo, 
   ...
   NameProfile, AgeProfile, BioProfile, Footer, NoMatch, Match } from "./StyledPages/styledHome"
...
function HomeScreen(props) {
  ...
  const getProfiles = () => {
    axios.get('https://us-central1-missao-newton.cloudfunctions.net/astroMatch/dayane/person')
    .then(response => {
  ...
  const chooseProfile = () => {
    ...
    axios.post('https://us-central1-missao-newton.cloudfunctions.net/astroMatch/dayane/choose-person',
     body
    )
    .then(() => {
      getProfiles()
